    ...
    <>
      ...
      >
          ...
          <div className="p-4 space-y-6">
            ...
            <div>
              ...
              <nav className="space-y-1.5">
                <Link href="/" className={getNavClass('/')} onClick={closeSidebar}>
                  <Home className={`w-3.5 h-3.5 ${isActive('/') ? 'text-[#F2FD84]' : 'text-gray-500 group-hover:text-[#F2FD84]'}`} />
                  <span>Home Page</span>
                </Link>

                <Link href="/all-classes" className={getNavClass('/all-classes')} onClick={closeSidebar}>
                  <Compass className={`w-3.5 h-3.5 ${isActive('/all-classes') ? 'text-[#F2FD84]' : 'text-gray-500 group-hover:text-[#F2FD84]'}`} />
                  <span>All Classes</span>
                </Link>

                <Link href="/community-forum" className={getNavClass('/community-forum')} onClick={closeSidebar}>
            ...
            <div>
              ...
              <nav className="space-y-1.5">
                ...
                <Link href="/dashboard/user" className={getDashboardNavClass('/dashboard/user')} onClick={closeSidebar}>
                ...
                <Link href="/dashboard/user/booked-classes" className={getDashboardNavClass('/dashboard/user/booked-classes')} onClick={closeSidebar}>
                  <div className="flex items-center gap-3">
                ...
                <Link href="/dashboard/user/favorites" className={getDashboardNavClass('/dashboard/user/favorites')} onClick={closeSidebar}>
                  <div className="flex items-center gap-3">
                ...
                <Link href="/dashboard/user/apply-trainer" className={getDashboardNavClass('/dashboard/user/apply-trainer')} onClick={closeSidebar}>
                  <div className="flex items-center gap-3">
        ...
        <div className="p-4 border-t border-white/8 bg-[#141414]/50 space-y-3">
          <Link href='/profile' onClick={closeSidebar} className="flex items-center gap-3 p-2 rounded-xl bg-white/3 border border-white/5 backdrop-blur-sm transition-all duration-200 hover:border-[#F2FD84]/30 hover:shadow-[0_0_30px_-10px_rgba(242,253,132,0.15)] overflow-hidden hover:scale-99">
