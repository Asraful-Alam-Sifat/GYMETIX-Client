  ...
  const steps = [
    {
      ...
      desc: "Sign up in seconds and choose your fitness goals to personalize your experience.",
    },
    {
      id: "02",
      title: "Browse Classes",
      desc: "Explore hundreds of classes across Yoga, HIIT, Strength, Cardio, and more.",
    },
    {
      id: "03",
      title: "Book & Pay",
      desc: "Reserve your spot instantly with secure payment. Instant confirmation guaranteed.",
    },
    {
      id: "04",
      title: "Track Progress",
      desc: "Monitor your bookings, favorites, and milestones from your personal dashboard.",
    },
  ];
      ...
      <div className="sm:max-w-10/12 mx-auto px-6 relative z-20">
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading text-3xl md:text-5xl font-black uppercase text-white">
            ...
            <span className="text-[#F2FD84]">4 Steps</span>
          </h2>
        </div>
