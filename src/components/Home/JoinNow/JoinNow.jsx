    ...
    <section className="relative w-full py-25 flex items-center justify-center overflow-hidden bg-[#222222]">
      ...
      <div className="w-10/12 flex justify-end">
        <div className="relative z-10 max-w-4xl px-6">
          ...
          <Link href={user ? "/dashboard" : "/signup"} className="bg-[#F2FD84] hover:bg-white text-[#222222] font-bold rounded-box uppercase py-4 px-10 transition-all duration-300 hover:shadow-[0_0_30px_rgba(242,253,132,0.4)]">
            Join Now
          </Link>
        </div>
      </div>
