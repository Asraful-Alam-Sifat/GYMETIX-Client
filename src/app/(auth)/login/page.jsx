  ...
  return (
    <div className="relative flex flex-col justify-between min-h-screen w-full bg-[#1d1c1c] text-white font-sans px-6 md:px-12 py-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
        <div className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-200 h-200 rounded-full bg-radial from-yellow-500/10 via-transparent to-transparent blur-3xl"></div>
        <div className="absolute bottom-0 right-0 translate-x-1/3 translate-y-1/3 w-200 h-200 rounded-full bg-radial from-yellow-500/10 via-transparent to-transparent blur-3xl"></div>
      </div>
      ...
      <div className="relative z-20 grow grid grid-cols-1 md:grid-cols-2 w-full max-w-7xl mx-auto items-center gap-12 my-auto py-8">
        ...
        <div className="hidden md:flex flex-col justify-center max-w-lg gap-6">
          <div className="font-heading uppercase font-extrabold italic text-6xl flex items-center gap-0 text-[#F2FD84] bg-transparent">
            gym
          ...
          <div className="space-y-3">
            <h1 className="font-heading text-5xl flex flex-col gap-1 font-extrabold uppercase tracking-tight leading-none text-white drop-shadow-md">
              Unlock Your <br />
              <span className="text-[#F2FD84]">Potential</span>
            </h1>
            <p className="font-body text-zinc-300 text-sm sm:text-base font-medium leading-relaxed drop-shadow-sm">
              Step back into a community that combines strength, flexibility,
        ...
        <div className="relative flex justify-center items-center w-full group">
          <div className="absolute hidden md:block w-[110%] h-[110%] bg-[#e2ff3b]/10 rounded-box blur-[30px] pointer-events-none z-0 transition-all duration-500 ease-out group-hover:scale-105 group-hover:bg-[#e2ff3b]/15" />

          <div className="relative w-full max-w-md bg-zinc-950/75 backdrop-blur-xl border border-zinc-800/80 p-8 rounded-2xl shadow-2xl space-y-6 ring-1 ring-[#e2ff3b]/5 z-10 transition-all duration-500 ease-out hover:border-[#F2FD84]/40 hover:shadow-[0_0_40px_rgba(242,253,132,0.12)] group-hover:-translate-y-1">
            {/* Header */}
            ...
            <form className="space-y-4">
              ...
              <Link
                href="/"
                type="submit"
                className="font-heading inline-block text-center w-full bg-[#F2FD84] text-black font-extrabold text-lg uppercase tracking-wider py-2 rounded-lg border border-transparent shadow-lg shadow-[#F2FD84]/10 transition-all duration-300 ease-out hover:bg-zinc-950 hover:text-[#F2FD84] hover:border-[#F2FD84]/75 hover:shadow-sm hover:shadow-[#F2FD84]/20 active:scale-[0.99]"
              >
                Login
              </Link>
            </form>
            ...
            <p className="font-body text-center text-xs text-zinc-500 font-bold tracking-wide ">
              New to Gymetix?{" "}
              <Link
                href="/signup"
